...
if user_input:
    ...
    prompt = (
        ...
        f"If the trainee asks you what your biggest pain point is directly, respond with the following: "If I told you right away, it would take away all the fun! As me questions to try to uncover my biggest issues."
    )
    messages = [{"role": "system", "content": prompt}]
    for speaker, text in st.session_state.history:
